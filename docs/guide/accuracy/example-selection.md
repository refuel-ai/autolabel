...
This leads to an accuracy of 74.17%, a considerable improvement of ~8% over the zero-shot baseline.
...
With semantic similarity example selectiom, we obtain a 79.02% accuracy.
